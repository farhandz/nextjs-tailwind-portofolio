          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              <div>
                <Fade>
                  <h2 className="lg:mx-5 lg:my-2 font-yusei">
                    ...
                    Taka App has feature private chat and friend list. Taka Chat
                    has feature share location. Taka Chat developed using
                    javascript environment such as vue js , express, node,
                    socket io, and mysql
                  </h2>
                </Fade>
            ...
            <div className="bg-white flex flex-col  ">
              ...
              <div>
                <Fade>
                  <h2 className="lg:mx-5 lg:my-2 font-yusei">
                    Taka Pos is a aplication poin of sales Taka Pos Has feature
                    add to cart, Taka Pos has Feature dialy report, monthly
                    report in pdf format and can print from the browser, Taka
                    Chat developed using javascript environment such as vue js ,
                    express, node, socket io, and mysql, redis
                  </h2>
                </Fade>
                <p
            ...
            <div className="bg-white flex flex-col  ">
              ...
              <div>
                ...
                <p
                  onClick={() =>
                    window.open("https://peaceful-mestorf-3bd649.netlify.app")
                  }
                  className="text-blue-500 font-bold text-2xl text-center cursor-pointer"
                >
                  demo
              ...
              <div>
                <Fade>
                  <h2 className="lg:mx-5 lg:my-2 font-yusei">
                    ...
                    developed using javascript environment such as React js ,
                    Nest js, node, Redux, Redux thun, rxjs and mongodb
                  </h2>
                </Fade>
              </div>
            </div>
              ...
              <div>
                <Fade>
                  <h2 className="g:mx-5 lg:my-2 font-yusei">
                    ...
                    alquran. Quran developed using javascript environment such
                    as React js
                  </h2>
                </Fade>
              </div>
